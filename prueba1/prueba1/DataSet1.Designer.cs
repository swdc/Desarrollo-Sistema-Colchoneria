...
namespace prueba1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public clienteRow AddclienteRow(string Nombre, string Apellido, System.DateTime FechaNacimiento, string Direccion) {
...
namespace prueba1.DataSet1TableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `cliente` (`Nombre`, `Apellido`, `FechaNacimiento`, `Direccion`) VALU" +
                "ES (@p1, @p2, @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `cliente` SET `Nombre` = @p1, `Apellido` = @p2, `FechaNacimiento` = @p3, `" +
                "Direccion` = @p4 WHERE ((`IdCliente` = @p5) AND (`Nombre` = @p6) AND (`Apellido`" +
                " = @p7) AND (`FechaNacimiento` = @p8))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::prueba1.Properties.Settings.Default.campeonatoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `IdCliente`, `Nombre`, `Apellido`, `FechaNacimiento`, `Direccion` FROM `cl" +
                "iente`";
        ...
        public virtual int Update(string p1, string p2, System.DateTime p3, string p4, int p5, string p6, string p7, System.DateTime p8) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
